...
function runDisplayAperiodicDataForSubjectGroupAcrossProtocols
...
% Age - all, young, mid
uicontrol('Parent',hPanel1,'Unit','Normalized','Position',[0 0 0.5 1/3],'Style','text','String','Group','FontSize',fontSizeSmall);
groupList = [{'Meditators'} {'Controls'}];
hGroup = uicontrol('Parent',hPanel1,'Unit','Normalized','BackgroundColor', backgroundColor, 'Position', [0.5 0 0.5 1/3],'Style','popup','String',groupList,'FontSize',fontSizeSmall);

%%%%%%%%%%%%%%%%%%%%%%%% Protocol Details %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
hPanel2 = uipanel('Title','Protocol','fontSize',fontSizeLarge,'Unit','Normalized','Position',[0.175 1-panelHeight 0.15 panelHeight]);

% Protocol
uicontrol('Parent',hPanel2,'Unit','Normalized','Position',[0 2/3 0.5 1/3],'Style','text','String','Protocol 1','FontSize',fontSizeSmall);
...
% RefChoice
uicontrol('Parent',hPanel2,'Unit','Normalized','Position',[0 0 0.5 1/3],'Style','text','String','protocol 2','FontSize',fontSizeSmall);
refChoiceList = protocolNameList;
...
freqRangeList0{1} = [86 13];
freqRangeList0{2} = [22 34];
freqRangeList0{3} = [30 80];
...
for i=1:numFreqRanges
    if i==1
        uicontrol('Parent',hPanel4,'Unit','Normalized','Position',[0 1-i/numFreqRanges 0.5 1/numFreqRanges],'Style','text','String','FreqWidth','FontSize',fontSizeSmall);
    else
...
axisRangeList0{1} = [0 200]; axisRangeName{1} = 'Freq Lims (Hz)';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function plot_Callback(~,~)
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        groupType = groupList{get(hGroup,'val')};
        ...
        displayAperiodicDataForSubjectGroupAcrossProtocols(subjectNameLists,protocolName,analysisChoice,refChoice,badEyeCondition,badTrialVersion,badElectrodeRejectionFlag,freqRangeList,axisRangeList,cutoffList,useMedianFlag,hAllPlots,pairedDataFlag,groupType);
    end
